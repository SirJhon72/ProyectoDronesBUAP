...
public class MonitoresPanel extends javax.swing.JPanel {
    ...
    protected Monitores DroneSemp1, DroneSemp2, DroneSemp3 , DroneSemp4, DroneSemp5,
    ...
    protected void InicializacionMonitores(){
        ...
        DroneSemp1 = new Monitores(DroneX1, DroneY1, DroneG1, this);
        ...
        DroneSemp2 = new Monitores(DroneX1, DroneY1, DroneG2, this);
        ...
        DroneSemp3 = new Monitores(DroneX1, DroneY1, DroneG3, this);
        ...
        DroneSemp4 = new Monitores(DroneX1, DroneY1, DroneG4, this);
        ...
        DroneSemp5 = new Monitores(DroneX1, DroneY1, DroneG5, this);
        ...
        DroneSemp6 = new Monitores(DroneX1, DroneY1, DroneG6, this);
        ...
        DroneSemp7 = new Monitores(DroneX1, DroneY1, DroneG7, this);
        ...
        DroneSemp8 = new Monitores(DroneX1, DroneY1, DroneG8, this);
        ...
        DroneSemp9 = new Monitores(DroneX1, DroneY1, DroneG9, this);
        ...
        DroneSemp10 = new Monitores(DroneX1, DroneY1, DroneG10, this);
    ...
    protected void InicializarDronesMonitores(int NoDrones){
        switch(NoDrones){
            //PARA 1 DRONE
            case 1:
                Reinicializar();
...
//                //Hilo
    ...
    protected ChartPanel GenerarGraficaMonitores(){
        //Detenemos los hilos
        DroneSemp1.Detener();
        DroneSemp2.Detener();
        DroneSemp3.Detener();
        ...
        JFreeChart chart = ChartFactory.createXYLineChart("Tiempo Espera Monitores", "Iteraciones", "Tiempo", temporal);
        //Colocamos los rangos de nuestros valores
        chart.getXYPlot().getRangeAxis().setRange(0, 32);
