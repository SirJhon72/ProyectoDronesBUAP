...
public class VCondicionPanel extends javax.swing.JPanel {
    ...
    protected VCondicion DroneSemp1, DroneSemp2, DroneSemp3 , DroneSemp4, DroneSemp5,
    ...
    protected void InicializacionVariablesCondicion(){
        ...
        DroneSemp1 = new VCondicion(DroneX1, DroneY1, DroneG1, this, lock);
        ...
        DroneSemp2 = new VCondicion(DroneX1, DroneY1, DroneG2, this, lock);
        ...
        DroneSemp3 = new VCondicion(DroneX1, DroneY1, DroneG3, this, lock);
        ...
        DroneSemp4 = new VCondicion(DroneX1, DroneY1, DroneG4, this, lock);
        ...
        DroneSemp5 = new VCondicion(DroneX1, DroneY1, DroneG5, this, lock);
        ...
        DroneSemp6 = new VCondicion(DroneX1, DroneY1, DroneG6, this, lock);
        ...
        DroneSemp7 = new VCondicion(DroneX1, DroneY1, DroneG7, this, lock);
        ...
        DroneSemp8 = new VCondicion(DroneX1, DroneY1, DroneG8, this, lock);
        ...
        DroneSemp9 = new VCondicion(DroneX1, DroneY1, DroneG9, this, lock);
        ...
        DroneSemp10 = new VCondicion(DroneX1, DroneY1, DroneG10, this, lock);
    ...
    protected void InicializarDronesVariablesCondicion(int NoDrones){
        switch(NoDrones){
            //PARA 1 DRONE
            case 1:
                Reinicializar();
    ...
    protected ChartPanel GenerarGraficaVCondicion(){
        //Detenemos los hilos
        DroneSemp1.Detener();
        DroneSemp2.Detener();
        DroneSemp3.Detener();
        ...
        //Quitamos los puntos a las lineas visibles
          for(int i = 0; i < 10; i++){
        ...
        JFreeChart chart = ChartFactory.createXYLineChart("Tiempo Espera VCondicion", "Iteraciones", "Tiempo", temporal);
